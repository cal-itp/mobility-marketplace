...
```css
.font-heading {
  font-family: var(--dsdl-heading-font-stack) !important;
}
.font-body {
  font-family: var(--dsdl-body-font-stack) !important;
}
.font-monospace {
  font-family: var(--dsdl-monospace-font-stack) !important;
}
```
...
```css
.line-height-extra-tight {
  line-height: var(--line-height-extra-tight) !important;
}
.line-height-tight {
...
```css
.text-brand-blue {
  color: var(--calitp-brand-blue) !important;
}
```
